...
#define ALLOC_A(alloc, size, align)      (alloc).proc((alloc).state, M_ALLOC,   nullptr, 0, size,      align)
...
#define REALLOC_A(alloc, ptr, osize, size, align) (alloc).proc((alloc).state, M_REALLOC, ptr,     osize, size, align)
